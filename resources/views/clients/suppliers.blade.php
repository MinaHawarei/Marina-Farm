<x-app-layout>
    ...
    <div class="p-6">
        ...
        <h1 class="text-2xl font-bold mb-4">الموردين</h1>
        ...
        <table class="w-full border border-gray-400 text-center bg-white" id="client-table">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="border px-2 py-1">نوع التوريدات</th>
                    <th class="border px-2 py-1">اجمالي قيمة التوريدات</th>
    ...
    <script>
        function saveClient(button, clientId) {
            ...
            if (clientId === 'new') {
                ...
                form.action = "{{ url('/suppliers') }}/" + clientId;
