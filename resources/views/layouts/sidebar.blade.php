...
<div class="w-64" style="background-color: #040629;"> <!-- لون خلفية القائمة -->
        ...
        <div x-data="{ isOpen: {{ request()->routeIs('treasury.*') ? 'true' : 'false' }} }" class="relative">
            ...
            >
                ...
                <a href="{{ route('treasury.liabilities') }}"
                    class="flex justify-between items-center px-6 py-3 font-bold border-r-4 transition duration-200"
                    style="{{ request()->routeIs('treasury.liabilities') ? 'background-color: #f4f4f4; color: #2c3e50; border-color: transparent; border-radius: 0 15px 15px 0;' : 'color: #cccccc;' }}">
                    <div class="flex items-center">
                        <i class="fas fa-tachometer-alt ml-2"></i>
                ...
                <a href="{{ route('treasury.receivables') }}"
                    class="flex justify-between items-center px-6 py-3 font-bold border-r-4 transition duration-200"
                    style="{{ request()->routeIs('treasury.receivables') ? 'background-color: #f4f4f4; color: #2c3e50; border-color: transparent; border-radius: 0 15px 15px 0;' : 'color: #cccccc;' }}">
                    <div class="flex items-center">
                        <i class="fas fa-tachometer-alt ml-2"></i>
        ...
        <div x-data="{ isOpen: {{ request()->routeIs('stock.*') ? 'true' : 'false' }} }" class="relative">
            ...
            <div x-show="isOpen" x-collapse class="pr-6" style="background-color: #040629;">
                ...
                <a href="{{ route('stock.producs') }}"
                    class="flex justify-between items-center px-6 py-3 font-bold border-r-4 transition duration-200"
                    style="{{ request()->routeIs('stock.producs') ? 'background-color: #f4f4f4; color: #2c3e50; border-color: transparent; border-radius: 0 15px 15px 0;' : 'color: #cccccc;' }}">
                    <div class="flex items-center">
                        <i class="fas fa-tachometer-alt ml-2"></i>
                ...
                <a href="{{ route('stock.feeds') }}"
                    class="flex justify-between items-center px-6 py-3 font-bold border-r-4 transition duration-200"
                    style="{{ request()->routeIs('stock.feeds') ? 'background-color: #f4f4f4; color: #2c3e50; border-color: transparent; border-radius: 0 15px 15px 0;' : 'color: #cccccc;' }}">
                    <div class="flex items-center">
                        <i class="fas fa-tachometer-alt ml-2"></i>
                        <span class="mr-2">اعلاف</span>
                    </div>
                </a>
                <a href="{{ route('stock.other') }}"
                    class="flex justify-between items-center px-6 py-3 font-bold border-r-4 transition duration-200"
                    style="{{ request()->routeIs('stock.other') ? 'background-color: #f4f4f4; color: #2c3e50; border-color: transparent; border-radius: 0 15px 15px 0;' : 'color: #cccccc;' }}">
                    <div class="flex items-center">
                        <i class="fas fa-tachometer-alt ml-2"></i>
